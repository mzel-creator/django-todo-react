...
class TestSequenceFunctions(unittest.TestCase):
        ...
        MSVSSettings.ValidateMSBuildSettings(
            {
                ...
                "ProjectReference": {"LinkLibraryDependencies": "true", "UseLibraryDependencyInputs": "true"},
    ...
    def testConvertToMSBuildSettings_minimal(self):
        ...
        msvs_settings = {
            ...
            "VCLinkerTool": {"LinkTimeCodeGeneration": "1", "ErrorReporting": "1", "DataExecutionPrevention": "2"},
        }
        expected_msbuild_settings = {
            "ClCompile": {
                "AdditionalIncludeDirectories": "dir1",
    ...
    def testConvertToMSBuildSettings_warnings(self):
        ...
        expected_msbuild_settings = {
            "ClCompile": {"AdditionalIncludeDirectories": "1", "AdditionalOptions": "2"},
            "Link": {},
            "ResourceCompile": {
                # Custom
                "Culture": "0x03eb"
    ...
    def testConvertToMSBuildSettings_full_synthetic(self):
        ...
        expected_msbuild_settings = {
            ...
            "ProjectReference": {"LinkLibraryDependencies": "true", "UseLibraryDependencyInputs": "false"},
            "": {
                "EmbedManifest": "true",
                "GenerateManifest": "true",
                "IgnoreImportLibrary": "true",
    ...
    """
        ...
        expected_msbuild_settings = {
            ...
            "ProjectReference": {"LinkLibraryDependencies": "false", "UseLibraryDependencyInputs": "true"},
            "": {
                "EmbedManifest": "false",
                "GenerateManifest": "false",
                "IgnoreImportLibrary": "true",
            ...
            "ManifestResourceCompile": {"ResourceOutputFileName": "$(IntDir)$(TargetFileName).embed.manifest.resfdsf"},
        }
        actual_msbuild_settings = MSVSSettings.ConvertToMSBuildSettings(msvs_settings, self.stderr)
        self.assertEqual(expected_msbuild_settings, actual_msbuild_settings)
        self._ExpectedWarnings([])

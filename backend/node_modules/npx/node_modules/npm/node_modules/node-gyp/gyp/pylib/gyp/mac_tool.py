  ...
  executed directly, or dispatched from an argument list."""
    ...
    """
        ...
        subprocess.check_call(
            [
                ...
                "--entitlements",
                entitlements_path,
                os.path.join(os.environ["TARGET_BUILD_DIR"], os.environ["FULL_PRODUCT_NAME"]),
            ]
        )
    ...
    """
        ...
        target_path = os.path.join(
            os.environ["BUILT_PRODUCTS_DIR"], os.environ["CONTENTS_FOLDER_PATH"], "ResourceRules.plist"
        )
        if not source_path:
    ...
    """
        ...
        target_path = os.path.join(
            os.environ["BUILT_PRODUCTS_DIR"], os.environ["CONTENTS_FOLDER_PATH"], "embedded.mobileprovision"
        )
        shutil.copy2(source_path, target_path)

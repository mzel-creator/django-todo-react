...
class MsvsSettings(object):
  ...
  class helps map those settings to command line options."""
    ...
    class _GetWrapper(object):
        ...
        def __call__(self, name, map=None, prefix="", default=None):
            return self.parent._GetAndMunge(
                self.field, self.base_path + [name], default=default, prefix=prefix, append=self.append, map=map
            )
    ...
    def GetCflags(self, config):
        ...
        cflags.extend(
            ["/FI" + f for f in self._Setting(("VCCLCompilerTool", "ForcedIncludeFiles"), config, default=[])]
        )
    ...
    manifest files."""
        ...
        ld(
            "SubSystem",
            map={"1": "CONSOLE%s" % minimum_required_version, "2": "WINDOWS%s" % minimum_required_version},
            prefix="/SUBSYSTEM:",
        )
        ...
        manifest_flags, intermediate_manifest, manifest_files = self._GetLdManifestFlags(
            config, manifest_base_name, gyp_to_build_path, is_executable and not have_def_file, build_dir
        )
